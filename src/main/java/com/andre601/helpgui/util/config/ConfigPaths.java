...
public final class ConfigPaths {
    ...
    public static String MSG_SEARCH_INV_TITLE  = "Messages.SearchInv.Title";
    public static String MSG_PLAYERS_FOUND     = "Messages.SearchInv.PlayersFound";
    public static String MSG_PLUGIN_LOADED     = "Messages.Startup.PluginLoaded";
    ...
    public static String MSG_FEW_ARGS          = "Messages.Commands.FewArgs";
    public static String MSG_UNKNOWN_ARGS      = "Messages.Commands.UnknownArg";
    public static String MSG_NO_PERM           = "Messages.Commands.NoPerm";
    public static String MSG_CMD_DESCRIPTION   = "Messages.Commands.CommandDescription";
